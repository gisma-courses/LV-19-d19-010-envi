...
[Marburg Open Forest data base](https://marburgopenforest.github.io/MOFknowledge/) Marburg Open Forest data base for static data. You will find some example R-code for manipulation and extraction. Additionally the data is in a QGIS pProject container.
