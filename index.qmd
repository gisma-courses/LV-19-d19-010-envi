...
![Current situation at the Hasenkopf site](images/hasenkopf_original.bmp){width="50%"} 

![Planned situation at the Hasenkopf site](images/hasenkopf_planung.bmp){width="50%"}
